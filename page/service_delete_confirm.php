            ...
            <div class="panel-body">
               ...
               <div class="form-group">
                  <label for="emp">Id service</label>
                       <input name="idservice" type=text class="form-control" value="<?php  echo $data['idservice'];?>" readonly=>
                       <input name="idserviceE" type=hidden class="form-control" value="<?php  echo $data['idservice'];?>" >
                  <label for="emp">Nom service</label>
                       <input name=nomservice type=text class="form-control" value="<?php echo $data['nomservice']; ?>" readonly=>
                </div>
            <div class="form-group ">
